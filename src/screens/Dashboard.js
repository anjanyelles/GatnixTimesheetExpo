      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.cardContainer}>
          ...
          <View style={styles.row}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate("Employee")}>
                <View style={styles.iconRow}>
                  ...
                  <Text style={styles.cardValue}>
                    {dashbordcards?.numberOfEmployees ?? "0"}
                  </Text>
                </View>
              </TouchableOpacity>
            ...
            <View style={styles.card}>
              <TouchableOpacity
                onPress={() => navigation.navigate("ApprovedSheets")}
              >
                <View style={styles.iconRow}>
                  <FontAwesome5 name="clock" size={20} color="orange" />
                  <Text style={styles.cardValue}>
                    {dashbordcards?.approvedTimesheets ?? "0"}
                  </Text>
                </View>
            ...
            <View style={styles.card}>
              <TouchableOpacity onPress={() => navigation.navigate("Project")}>
                <View style={styles.iconRow}>
                  ...
                  <Text style={styles.cardValue}>
                    {dashbordcards?.numberOfProjects ?? "0"}
                  </Text>
                </View>
              </TouchableOpacity>
            ...
            <View style={styles.card}>
              ...
              >
                <View style={styles.iconRow}>
                  ...
                  <Text style={styles.cardValue}>
                    {dashbordcards?.totalTimesheets ?? "0"}
                  </Text>
                </View>
              </TouchableOpacity>
