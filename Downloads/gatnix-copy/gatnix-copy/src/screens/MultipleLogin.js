...
import {getEmployeeData,getEmployeeNotifications,getEmployeeSummary,getEmployeeWeeklyCount} from './aftherlogin';
...
const MultipleLogin = ({ data }) => {
  ...
  useEffect(() => {
    ...
    //   try {
    //     console.log("Fetching all employee-related data...");
    
    //     const [profile, notifications, summary, weeklyCount] = await Promise.all([
    //       getEmployeeData(),
    //       getEmployeeNotifications(),
    //       getEmployeeSummary(),
    //       getEmployeeWeeklyCount(),
    //     ]);
