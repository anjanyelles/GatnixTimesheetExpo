 ...
 if (["approvalManagers", "super-admin", "employee"].includes(userRole)) {
      if (mode === "edit_edu" && edu?.id) {
        ...
        response = await axios.post(
          `https://www.gatnix.com/api/v1/org/${orgId}/user/${userId}/user-profile/workDetails/association/${userRole}`,
          requestData,
          { headers: { "Content-Type": "application/json" } }
        );
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContainer}>
        <View style={styles.mainContainer}>
          <Text style={styles.headerText}>
            {edu?.id ? "Update Job Details" : "Add Job Details"}
          </Text>
          ...
          <TextInput
            style={[
              styles.input,
              jobDetails.jobTitle_Error && styles.errorInput,
            ]}
          ...
          />
          {jobDetails.jobTitle_Error && (
            <Text style={styles.errorText}>
              {jobDetails.jobTitle_ErrorText}
            </Text>
          )}
          ...
          <TextInput
            style={[
              styles.input,
              jobDetails.companyName_Error && styles.errorInput,
            ]}
          ...
          />
          {jobDetails.companyName_Error && (
            <Text style={styles.errorText}>
              {jobDetails.companyName_ErrorText}
            </Text>
          )}
          ...
          <TextInput
            style={[
              styles.input,
              jobDetails.startDate_Error && styles.errorInput,
            ]}
          ...
          />
          {jobDetails.startDate_Error && (
            <Text style={styles.errorText}>
              {jobDetails.startDate_ErrorText}
            </Text>
          )}
          ...
          <TextInput
            style={[
              styles.input,
              jobDetails.endDate_Error && styles.errorInput,
            ]}
            placeholder="YYYY-MM-DD"
            keyboardType="numeric"
          ...
          <TextInput
            style={[
              styles.input,
              jobDetails.description_Error && styles.errorInput,
            ]}
          ...
          />
          {jobDetails.description_Error && (
            <Text style={styles.errorText}>
              {jobDetails.description_ErrorText}
            </Text>
          )}
